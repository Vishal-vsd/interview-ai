...
import { deleteUser, getAdminStats, getAllInterviews, getAllUsers, getInterviewByIdAdmin, getUserDetails } from "../controllers/adminController";
...
router.get("/users/:id", authMiddleware,authorizedRoles("admin"), getUserDetails)
